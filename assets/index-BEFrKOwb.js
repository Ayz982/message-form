...
`;a(document.querySelector("#counter"));document.querySelector("#go-to-form").addEventListener("click",()=>{window.location.href="public/formPage.html"});
